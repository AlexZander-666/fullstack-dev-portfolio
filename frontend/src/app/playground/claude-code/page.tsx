...
const terminalLines: TerminalLine[] = [
  ...
  {
    type: "output",
    text: "Drafting plan to migrate session-based auth to JWT...",
  },
  ...
  <div className="w-full max-w-2xl mx-auto overflow-hidden rounded-xl shadow-2xl border border-stone-800/50 bg-[#1e1e1e] font-mono text-sm leading-relaxed">
    ...
    <div className="p-6 space-y-3 min-h-[320px] text-stone-300">
      {terminalLines.map((line, index) => (
        <div key={`${line.text}-${index}`} className="flex flex-col animate-fadeIn">
          {line.type === "command" && (
    ...
    <nav className="fixed top-0 w-full z-50 bg-[#f4f3ef]/90 backdrop-blur-md border-b border-stone-200/50">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-4">
          <button className="text-stone-900 font-medium text-sm hover:opacity-70 transition-opacity">
            Log in
          </button>
      ...
      {isOpen && (
        <div className="md:hidden absolute top-16 left-0 w-full bg-[#f4f3ef] border-b border-stone-200 p-6 space-y-4 shadow-xl">
          <a href="#" className="block text-stone-900 font-medium">
            Research
          </a>
          <a href="#" className="block text-stone-900 font-medium">
            Product
          ...
          <button className="w-full bg-[#1a1a1a] text-white py-3 rounded-lg font-medium">
            Try Claude Code
          </button>
        </div>
      )}
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-8 animate-fadeInUp">
            ...
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-medium tracking-tight leading-[1.05] text-[#1a1a1a]">
              The agentic coding tool that lives in your{" "}
              <span className="italic text-stone-500 font-serif">terminal</span>.
            </h1>
          ...
          <div>
            ...
            <div className="space-y-8">
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-stone-700 flex items-center justify-center flex-shrink-0 text-sm font-bold">
                  1
                </div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-[#d97757] flex items-center justify-center flex-shrink-0 text-sm font-bold">
                  3
                </div>
                <div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-stone-600">
              <li>
                <a href="#" className="hover:text-[#d97757]">
                  Claude Code
                </a>
              </li>
              <li>
